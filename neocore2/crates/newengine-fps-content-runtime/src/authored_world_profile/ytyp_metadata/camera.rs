...
pub fn apply_required_camera_definition(profile: &mut AuthoredWorldProfile) -> Result<(), String> {
...
pub fn game_ready_metadata_namespace(entry: &serde_json::Value) -> Option<&serde_json::Value> {
