...
pub fn specs() -> &'static [Nef8FormatSpec] {
    &[
        Nef8FormatSpec {
            extension: nemat::EXTENSION,
            asset_kind: nemat::ASSET_KIND,
            content_kind: Some(nemat::CONTENT_KIND),
            semantic_gateway: nemat::SEMANTIC_GATEWAY,
            handler_service: nemat::HANDLER_SERVICE,
            selector_syntax: Some(nemat::SELECTOR_SYNTAX),
            purpose: nemat::PURPOSE,
            consumer_domains: nemat::CONSUMER_DOMAINS,
        },
        Nef8FormatSpec {
            extension: nepak::EXTENSION,
            asset_kind: nepak::ASSET_KIND,
            content_kind: None,
            semantic_gateway: nepak::SEMANTIC_GATEWAY,
            handler_service: nepak::HANDLER_SERVICE,
            selector_syntax: None,
            purpose: nepak::PURPOSE,
            consumer_domains: nepak::CONSUMER_DOMAINS,
        },
        Nef8FormatSpec {
            extension: neui::EXTENSION,
            asset_kind: neui::ASSET_KIND,
            content_kind: Some(neui::CONTENT_KIND),
            semantic_gateway: neui::SEMANTIC_GATEWAY,
            handler_service: neui::HANDLER_SERVICE,
            selector_syntax: Some(neui::SELECTOR_SYNTAX),
            purpose: neui::PURPOSE,
            consumer_domains: neui::CONSUMER_DOMAINS,
        },
        Nef8FormatSpec {
            extension: ybd::EXTENSION,
            asset_kind: ybd::ASSET_KIND,
            content_kind: Some(ybd::CONTENT_KIND),
            semantic_gateway: ybd::SEMANTIC_GATEWAY,
            handler_service: ybd::HANDLER_SERVICE,
            selector_syntax: Some(ybd::SELECTOR_SYNTAX),
            purpose: ybd::PURPOSE,
            consumer_domains: ybd::CONSUMER_DOMAINS,
        },
        Nef8FormatSpec {
            extension: ybn::EXTENSION,
            asset_kind: ybn::ASSET_KIND,
            content_kind: Some(ybn::CONTENT_KIND),
            semantic_gateway: ybn::SEMANTIC_GATEWAY,
            handler_service: ybn::HANDLER_SERVICE,
            selector_syntax: Some(ybn::SELECTOR_SYNTAX),
            purpose: ybn::PURPOSE,
            consumer_domains: ybn::CONSUMER_DOMAINS,
        },
        Nef8FormatSpec {
            extension: ycd::EXTENSION,
            asset_kind: ycd::ASSET_KIND,
            content_kind: Some(ycd::CONTENT_KIND),
            semantic_gateway: ycd::SEMANTIC_GATEWAY,
            handler_service: ycd::HANDLER_SERVICE,
            selector_syntax: Some(ycd::SELECTOR_SYNTAX),
            purpose: ycd::PURPOSE,
            consumer_domains: ycd::CONSUMER_DOMAINS,
        },
        Nef8FormatSpec {
            extension: ydd::EXTENSION,
            asset_kind: ydd::ASSET_KIND,
            content_kind: Some(ydd::CONTENT_KIND),
            semantic_gateway: ydd::SEMANTIC_GATEWAY,
            handler_service: ydd::HANDLER_SERVICE,
            selector_syntax: Some(ydd::SELECTOR_SYNTAX),
            purpose: ydd::PURPOSE,
            consumer_domains: ydd::CONSUMER_DOMAINS,
        },
        Nef8FormatSpec {
            extension: ydr::EXTENSION,
            asset_kind: ydr::ASSET_KIND,
            content_kind: Some(ydr::CONTENT_KIND),
            semantic_gateway: ydr::SEMANTIC_GATEWAY,
            handler_service: ydr::HANDLER_SERVICE,
            selector_syntax: Some(ydr::SELECTOR_SYNTAX),
            purpose: ydr::PURPOSE,
            consumer_domains: ydr::CONSUMER_DOMAINS,
        },
        Nef8FormatSpec {
            extension: yed::EXTENSION,
            asset_kind: yed::ASSET_KIND,
            content_kind: Some(yed::CONTENT_KIND),
            semantic_gateway: yed::SEMANTIC_GATEWAY,
            handler_service: yed::HANDLER_SERVICE,
            selector_syntax: Some(yed::SELECTOR_SYNTAX),
            purpose: yed::PURPOSE,
            consumer_domains: yed::CONSUMER_DOMAINS,
        },
        Nef8FormatSpec {
            extension: yfd::EXTENSION,
            asset_kind: yfd::ASSET_KIND,
            content_kind: Some(yfd::CONTENT_KIND),
            semantic_gateway: yfd::SEMANTIC_GATEWAY,
            handler_service: yfd::HANDLER_SERVICE,
            selector_syntax: Some(yfd::SELECTOR_SYNTAX),
            purpose: yfd::PURPOSE,
            consumer_domains: yfd::CONSUMER_DOMAINS,
        },
        Nef8FormatSpec {
            extension: neftd::EXTENSION,
            asset_kind: neftd::ASSET_KIND,
            content_kind: Some(neftd::CONTENT_KIND),
            semantic_gateway: neftd::SEMANTIC_GATEWAY,
            handler_service: neftd::HANDLER_SERVICE,
            selector_syntax: Some(neftd::SELECTOR_SYNTAX),
            purpose: neftd::PURPOSE,
            consumer_domains: neftd::CONSUMER_DOMAINS,
        },
        Nef8FormatSpec {
            extension: yld::EXTENSION,
            asset_kind: yld::ASSET_KIND,
            content_kind: Some(yld::CONTENT_KIND),
            semantic_gateway: yld::SEMANTIC_GATEWAY,
            handler_service: yld::HANDLER_SERVICE,
            selector_syntax: Some(yld::SELECTOR_SYNTAX),
            purpose: yld::PURPOSE,
            consumer_domains: yld::CONSUMER_DOMAINS,
        },
        Nef8FormatSpec {
            extension: ymap::EXTENSION,
            asset_kind: ymap::ASSET_KIND,
            content_kind: Some(ymap::CONTENT_KIND),
            semantic_gateway: ymap::SEMANTIC_GATEWAY,
            handler_service: ymap::HANDLER_SERVICE,
            selector_syntax: Some(ymap::SELECTOR_SYNTAX),
            purpose: ymap::PURPOSE,
            consumer_domains: ymap::CONSUMER_DOMAINS,
        },
        Nef8FormatSpec {
            extension: ymf::EXTENSION,
            asset_kind: ymf::ASSET_KIND,
            content_kind: Some(ymf::CONTENT_KIND),
            semantic_gateway: ymf::SEMANTIC_GATEWAY,
            handler_service: ymf::HANDLER_SERVICE,
            selector_syntax: Some(ymf::SELECTOR_SYNTAX),
            purpose: ymf::PURPOSE,
            consumer_domains: ymf::CONSUMER_DOMAINS,
        },
        Nef8FormatSpec {
            extension: ymt::EXTENSION,
            asset_kind: ymt::ASSET_KIND,
            content_kind: Some(ymt::CONTENT_KIND),
            semantic_gateway: ymt::SEMANTIC_GATEWAY,
            handler_service: ymt::HANDLER_SERVICE,
            selector_syntax: Some(ymt::SELECTOR_SYNTAX),
            purpose: ymt::PURPOSE,
            consumer_domains: ymt::CONSUMER_DOMAINS,
        },
        Nef8FormatSpec {
            extension: ypdb::EXTENSION,
            asset_kind: ypdb::ASSET_KIND,
            content_kind: Some(ypdb::CONTENT_KIND),
            semantic_gateway: ypdb::SEMANTIC_GATEWAY,
            handler_service: ypdb::HANDLER_SERVICE,
            selector_syntax: Some(ypdb::SELECTOR_SYNTAX),
            purpose: ypdb::PURPOSE,
            consumer_domains: ypdb::CONSUMER_DOMAINS,
        },
        Nef8FormatSpec {
            extension: ysc::EXTENSION,
            asset_kind: ysc::ASSET_KIND,
            content_kind: Some(ysc::CONTENT_KIND),
            semantic_gateway: ysc::SEMANTIC_GATEWAY,
            handler_service: ysc::HANDLER_SERVICE,
            selector_syntax: Some(ysc::SELECTOR_SYNTAX),
            purpose: ysc::PURPOSE,
            consumer_domains: ysc::CONSUMER_DOMAINS,
        },
        Nef8FormatSpec {
            extension: ytd::EXTENSION,
            asset_kind: ytd::ASSET_KIND,
            content_kind: Some(ytd::CONTENT_KIND),
            semantic_gateway: ytd::SEMANTIC_GATEWAY,
            handler_service: ytd::HANDLER_SERVICE,
            selector_syntax: Some(ytd::SELECTOR_SYNTAX),
            purpose: ytd::PURPOSE,
            consumer_domains: ytd::CONSUMER_DOMAINS,
        },
        Nef8FormatSpec {
            extension: ytf::EXTENSION,
            asset_kind: ytf::ASSET_KIND,
            content_kind: Some(ytf::CONTENT_KIND),
            semantic_gateway: ytf::SEMANTIC_GATEWAY,
            handler_service: ytf::HANDLER_SERVICE,
            selector_syntax: Some(ytf::SELECTOR_SYNTAX),
            purpose: ytf::PURPOSE,
            consumer_domains: ytf::CONSUMER_DOMAINS,
        },
        Nef8FormatSpec {
            extension: ytyp::EXTENSION,
            asset_kind: ytyp::ASSET_KIND,
            content_kind: Some(ytyp::CONTENT_KIND),
            semantic_gateway: ytyp::SEMANTIC_GATEWAY,
            handler_service: ytyp::HANDLER_SERVICE,
            selector_syntax: Some(ytyp::SELECTOR_SYNTAX),
            purpose: ytyp::PURPOSE,
        ...
        Nef8FormatSpec {
            ...
            semantic_gateway: yvr::SEMANTIC_GATEWAY,
            handler_service: yvr::HANDLER_SERVICE,
            selector_syntax: Some(yvr::SELECTOR_SYNTAX),
            purpose: yvr::PURPOSE,
            consumer_domains: yvr::CONSUMER_DOMAINS,
        },
        Nef8FormatSpec {
            extension: ywr::EXTENSION,
            asset_kind: ywr::ASSET_KIND,
            content_kind: Some(ywr::CONTENT_KIND),
            semantic_gateway: ywr::SEMANTIC_GATEWAY,
            handler_service: ywr::HANDLER_SERVICE,
            selector_syntax: Some(ywr::SELECTOR_SYNTAX),
            purpose: ywr::PURPOSE,
            consumer_domains: ywr::CONSUMER_DOMAINS,
        },
    ]
}
