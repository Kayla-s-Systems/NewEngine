...
//! Provider-owned file type descriptor for `.neui`.
//!
//! This crate is the authority for the `.neui` descriptor. The generic
...
pub fn file_type_descriptor() -> AssetFileTypeDescriptor {
    let mut descriptor = AssetFileTypeDescriptor {
        ...
        consumer_domains: vec![
            "engine.assets.ui".to_owned(),
            "engine.assets.graph".to_owned(),
            "engine.ui".to_owned(),
            "engine.ui.text".to_owned(),
            "engine.assets.textures".to_owned(),
