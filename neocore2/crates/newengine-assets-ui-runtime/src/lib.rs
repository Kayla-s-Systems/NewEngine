...
"#
    ...
    fn compiles_aurelia_asset_preview_stand_with_font_texture_and_binding_refs() {
        ...
        assert!(dependencies
            .iter()
            .any(|dep| dep == "assets/loading/loading_ui.ytd@newengine_logo"));
        assert!(dependencies
            .iter()
            .any(|dep| dep == "assets/ui/icons/builtin_icons.ytd@folder"));
        assert!(dependencies
            .iter()
        ...
        assert_eq!(
            logo.icon.as_deref(),
            Some("assets/loading/loading_ui.ytd@newengine_logo")
        );
        ...
        assert_eq!(
            ...
            Some("assets/ui/icons/builtin_icons.ytd@folder")
        );
