fn spawn_equipped_weapon_visual(
        ...
        return match admission {
            ...
            Err(payload) => {
                ...
                newengine_ulog_api::ulog::error!(
                    "fps-character: skinned weapon admission panicked owner={} item='{}' model='{}': {}",
                    owner.stable_u64(),
                    definition.name,
                    model_ref,
                    panic_message,
    ...
    newengine_ulog_api::ulog::info!(
        "fps-character: equipped weapon visual bound player={} item='{}' instance={} model='{}' parts={} attachment='right-hand-prop/authored-character-pose' alignment='authored-hand-frame'",
        owner.stable_u64(),
        definition.name,
