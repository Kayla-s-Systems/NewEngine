...
fn spawn_skinned_equipped_weapon_visual(
    ...
    newengine_ulog_api::ulog::info!(
        "fps-character: equipped weapon native skin bound player={} item='{}' model='{}' joints={} policy='authored weapon skin + YCD palette; character and weapon reload share PlayerWeaponState'",
        owner.stable_u64(),
        definition.name,
        model_ref,
