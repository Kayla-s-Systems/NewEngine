...
fn try_admit_shell_visual(
    ...
    newengine_ulog_api::ulog::info!(
        "fps-character: weapon casing visual admitted entity={} shot={} weapon_item={:016x} variant='{}' model='{}' parts={} persistence='physics-world' source='authored-item-definition'",
        owner.stable_u64(),
        ...
        if let Err(error) = try_admit_shell_visual(world, prims, mats, entity, casing) {
            ...
            if changed {
                newengine_ulog_api::ulog::warn!(
                    "fps-character: weapon casing visual deferred entity={} shot={} weapon_item={:016x} variant={} err='{}'",
                    entity.stable_u64(),
                    casing.shot_sequence,
                    casing.weapon_item_id,
                    casing.variant,
