...
pub use dto::{
    ...
    EntityExistsResponse, EntityInvokeRequest, EntityListRequest, EntityListResponse, EntityRecord,
...
pub use service::{
    ...
    ENTITY_RUNTIME_REQUIREMENT_SPEC, ENTITY_SERVICE_ID, ENTITY_SERVICE_METHOD_DESPAWN_JSON_V1,
    ENTITY_SERVICE_METHOD_EXISTS_JSON_V1, ENTITY_SERVICE_METHOD_INFO, ENTITY_SERVICE_METHOD_INVOKE,
