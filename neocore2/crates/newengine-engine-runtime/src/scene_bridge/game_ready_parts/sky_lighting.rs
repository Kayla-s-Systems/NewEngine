...
pub(in crate::scene_bridge::game_ready) fn configure_game_ready_lighting(
    ...
    crate::gameplay::attach_scene_element_core(
        world,
        sun_entity,
        crate::gameplay::SceneEntityRole::Sun,
    ...
    crate::gameplay::attach_scene_element_core(
        world,
        sky_cycle_anchor,
        crate::gameplay::SceneEntityRole::SkyCycle,
    ...
    newengine_ulog_api::ulog::info!(
        "game-ready sky cycle: tod={:.2}h day_of_year={} day_len={:.1}s ambient={:?}/{:.3} sun_dir={:?} sun={:?}/{:.3} shadows={} strength={:.3} sun_entity={:?} sky_cycle_anchor={:?} policy='scene-owned semantic anchors are entities'",
