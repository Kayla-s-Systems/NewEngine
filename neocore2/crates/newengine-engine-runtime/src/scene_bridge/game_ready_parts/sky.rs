...
pub(in crate::scene_bridge::game_ready) use self::sky_lighting::configure_game_ready_lighting;
pub use self::sky_runtime::tick_game_ready_sky_cycle;
pub(in crate::scene_bridge::game_ready) use self::sky_types::{
...
pub(crate) use self::sky_types::{
    ...
    SkyClearColorRuntime, SkyCycleRuntime, SkyDomeRuntime, SkyDynamicsRuntime, SkyPostFxRuntime,
    SkyVisualKind, SkyVisualRuntime, SpatialCloudShadowRuntime,
};
