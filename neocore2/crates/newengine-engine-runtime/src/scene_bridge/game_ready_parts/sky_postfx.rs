...
#[inline]
pub(super) fn sky_postfx_sanitize(mut value: SkyPostFxRuntime) -> SkyPostFxRuntime {
...
pub(super) fn sky_postfx_from_environment(
    ...
    sky_postfx_sanitize(SkyPostFxRuntime {
        exposure,
        gamma: 2.2,
        black_lift,
        saturation,
...
pub(super) fn sky_postfx_from_authored_frame(frame: &SkyFrameSample) -> SkyPostFxRuntime {
