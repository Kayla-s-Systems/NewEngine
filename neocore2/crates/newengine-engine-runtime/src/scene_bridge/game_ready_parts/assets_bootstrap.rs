...
pub(in crate::scene_bridge) fn bootstrap_fps_game_ready_scene(
    ...
    *scene = Scene::new();
    ...
    newengine_ulog_api::ulog::info!(
        "game-ready bootstrap summary: title='{}' objective='{}' player={:?} terrain={:?} camera={:?} player_model_bound={} definitions={} prefabs={} foliage_enabled={} terrain_streaming_enabled={} terrain_chunk_radius={} terrain_unload_radius={} sky_mesh='{}' sky_definition_ref='{}'",
        map.title,
        map.objective,
        player,
        terrain,
