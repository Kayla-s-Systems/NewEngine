...
pub use combat::{
    ...
    WeaponAccuracyState, WeaponAttackKind, WeaponEvent, WeaponEventBus, WeaponEventKind,
    WeaponFireControllerState, WeaponObstructionState,
};
pub use components::{
...
pub use inventory::{
    ...
    equip_item_instance, equipped_reserve_ammo, give_item, install_weapon_component,
    inventory_quantity, persist_equipped_weapon_state, play_equipped_weapon_audio,
    play_weapon_item_audio, preload_weapon_audio_definition, remove_item, remove_weapon_component,
    select_equipment_slot, select_highest_ranked_equipped_weapon, spawn_item_pickup,
    spawn_persistent_item_pickup, step_world_items, sync_equipped_weapon_runtime,
    try_collect_item_pickup, unequip_slot, use_item, AmmoDefinition, AmmoProjectileType,
    EquipmentSlot, EquippedWeaponBinding, EquippedWeaponEntity, EquippedWeaponMuzzle,
    FirearmWeaponDefinition, FiringPatternDefinition, FiringPatternKind, InventoryEntry,
    ...
    WeaponCapabilities, WeaponCasingDefinition, WeaponComponentDefinition,
    WeaponComponentGraphDefinition, WeaponComponentInstance, WeaponComponentModifiers,
    WeaponComponentPointDefinition, WeaponEntityRuntime, WeaponEntitySockets, WeaponFireMode,
    WeaponItemDefinition, WeaponPresentationDefinition, WeaponSocketPose, WeaponType,
