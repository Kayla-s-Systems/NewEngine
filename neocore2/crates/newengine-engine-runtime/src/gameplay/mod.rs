...
pub use inventory::{
    ...
    use_item, EquipmentSlot, EquippedWeaponBinding, EquippedWeaponMuzzle, InventoryEntry,
...
pub use player::{
    ...
    is_player_controller_enabled, player_render_model_matrix, publish_player_render_poses,
