...
pub struct InventoryHudState {
    ...
    /// Consecutive command samples without the M pulse. The latch is re-armed only
    /// after a stable release window because Compass/Win32 can deliver a short burst
    /// of duplicate press/release pairs for one physical transition.
    pub character_toggle_release_streak: u16,
...
impl Default for InventoryHudState {
    fn default() -> Self {
        Self {
            ...
            character_toggle_release_streak: 0,
