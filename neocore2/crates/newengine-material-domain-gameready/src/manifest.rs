...
pub(super) struct GameReadyLitShaderManifest {
    #[allow(dead_code)]
    schema: String,
    pub(super) shaders: GameReadyLitShaderSetManifest,
}
...
#[derive(Clone, Deserialize)]
pub(super) struct GameReadyLitShaderSetManifest {
    pub(super) lit_vs: GameReadyShaderAssetRef,
    pub(super) lit_fs: GameReadyShaderAssetRef,
    pub(super) gbuffer_fs: GameReadyShaderAssetRef,
    pub(super) gbuffer_terrain_fs: GameReadyShaderAssetRef,
    pub(super) terrain_fs: GameReadyShaderAssetRef,
    pub(super) shadow_vs: GameReadyShaderAssetRef,
    pub(super) shadow_fs: GameReadyShaderAssetRef,
    pub(super) instanced_vs: GameReadyShaderAssetRef,
    pub(super) instanced_fs: GameReadyShaderAssetRef,
    pub(super) shadow_instanced_vs: GameReadyShaderAssetRef,
}
...
#[derive(Clone, Deserialize)]
pub(super) struct GameReadyShaderAssetRef {
