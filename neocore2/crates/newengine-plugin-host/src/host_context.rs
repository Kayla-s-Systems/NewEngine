...
pub use gateway::{
    ...
    declare_engine_composition, engine_gateway_has_capability,
...
pub use state::{
    activate_host_context, bump_services_generation, create_host_context, current_host_context,
    init_host_context, services_generation, with_host_context, with_host_module_callback,
...
pub(crate) use state::{
    ...
    environment_var_os, reject_topology_mutation_from_host_callback, with_current_plugin_id,
    ServiceCallLease, ServiceEntry, ServiceLifecycle,
};
