...
fn scanned_kind_label(kind: &ScannedDynlibKind) -> &'static str {
    match kind {
        ...
        ScannedDynlibKind::LegacyRenderBackend { .. } => "legacy-render-abi",
...
fn scanned_id(kind: &ScannedDynlibKind) -> String {
    match kind {
        ...
        ScannedDynlibKind::LegacyRenderBackend { id, .. } => id.clone(),
...
fn scanned_version(kind: &ScannedDynlibKind) -> String {
    match kind {
        ...
        ScannedDynlibKind::LegacyRenderBackend { version, .. } => version.clone(),
...
fn scanned_declared_caps(kind: &ScannedDynlibKind) -> String {
    match kind {
        ...
        ScannedDynlibKind::LegacyRenderBackend { .. } => "-".to_owned(),
        ScannedDynlibKind::Plugin {
