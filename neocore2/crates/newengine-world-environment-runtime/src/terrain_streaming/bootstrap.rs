...
fn launch_blocking_warm_radius(target_radius: i32) -> i32 {
    let default_launch_warm_radius = newengine_game_data::default_game_data()
        ...
        .streaming
        .launch_warm_radius;
    let requested = newengine_runtime_env::var_i32(
...
#[inline]
pub fn spawn_procedural_terrain(
    ...
    newengine_ulog_api::ulog::info!(
        "world-environment: terrain generator id='{}' seed={} cells={}x{} chunk_size={}x{} streaming={} radius={} unload_radius={} surface_mode='multi_textured' layer_count={} heightmap_enabled={} surface_layers=[forest='{}', sand='{}', rock='{}']",
        spec.generator.id,
        spec.seed,
        spec.cells_x,
        spec.cells_z,
    ...
    if spec.streaming.enabled {
        ...
        .sanitized();
        let mut state = AuthoredTerrainStreamingState {
            root,
        ...
        // chunks are admitted by tick_authored_streaming_terrain() through the
