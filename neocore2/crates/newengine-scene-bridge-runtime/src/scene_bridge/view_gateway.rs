...
#[allow(dead_code)]
#[derive(Clone, Debug)]
pub struct EngineViewGatewayFrame {
    pub frame_index: u64,
...
impl EngineViewGatewayFrame {
    #[inline]
    pub fn unjittered_view_projection(&self) -> Mat4 {
...
#[derive(Clone, Debug)]
pub struct EngineViewDiagnostics {
...
impl From<newengine_camera_gateway_runtime::CameraRuntimeOverlayReport> for EngineViewDiagnostics {
    #[inline]
    fn from(report: newengine_camera_gateway_runtime::CameraRuntimeOverlayReport) -> Self {
        Self {
...
pub enum EngineViewTransitionPhase {
    Idle,
    Pending,
    Blending,
}
...
#[derive(Clone, Debug)]
pub struct EngineViewTransitionDiagnostics {
    pub phase: EngineViewTransitionPhase,
    pub elapsed_sec: f32,
}

impl From<newengine_camera_gateway_runtime::CameraTransitionOverlayReport>
    for EngineViewTransitionDiagnostics
{
    #[inline]
    fn from(report: newengine_camera_gateway_runtime::CameraTransitionOverlayReport) -> Self {
        Self {
...
#[inline]
pub fn apply_engine_view_postfx(
...
impl SceneBridge {
    ...
    pub fn resolve_engine_view_frame(
        &self,
        world: &mut World,
