...
pub(super) fn publish_inspector_snapshot_to_surface(
    ...
    newengine_ui_client::publish_state_patch(&patch, "engine.scene", INSPECTOR_CONTRACT);
}
...
pub(super) fn physics_summary(
    body: newengine_gameplay_world_runtime::gameplay::PhysicsBodyDesc,
) -> String {
    format!(
...
pub(super) fn anchor_summary(
    anchor: &newengine_gameplay_world_runtime::gameplay::SceneEntityAnchor,
) -> String {
