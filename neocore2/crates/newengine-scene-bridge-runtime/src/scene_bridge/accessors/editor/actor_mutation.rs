    ...
    pub fn duplicate_selected_actors(&self) -> Vec<EntityId> {
        ...
        for source_root in roots {
            ...
            for source in &sources {
                ...
                clone_component!(*source, target, newengine_gameplay_world_runtime::gameplay::StaticMeshCollider);
                clone_component!(*source, target, newengine_gameplay_world_runtime::gameplay::PhysicsSurface);
                ...
                clone_component!(*source, target, newengine_gameplay_world_runtime::gameplay::ModelRenderComponent);
                clone_component!(*source, target, newengine_audio_api::AudioEmitter);
                clone_component!(*source, target, newengine_audio_api::AcousticSurface);
                clone_component!(*source, target, newengine_audio_api::AudioEnvironmentZone);
                clone_component!(*source, target, newengine_audio_api::AudioPortal);
                clone_component!(*source, target, newengine_audio_api::AudioAmbienceBed);
                clone_component!(*source, target, newengine_gameplay_world_runtime::gameplay::GameplayActor);
                clone_component!(*source, target, newengine_gameplay_world_runtime::gameplay::SceneEntityAnchor);
