impl SceneBridge {
    pub(super) fn publish_in_game_editor_state(&self, enabled: bool) {
        ...
        newengine_ui_client::publish_state_patch(&patch, "engine.scene", IN_GAME_EDITOR_CONTRACT);
    }
    ...
    pub fn refresh_editor_inspector(&self) {
    ...
    pub fn inspector_snapshot_json(&self, selected: Option<EntityId>) -> serde_json::Value {
        ...
        let physics_component = world
            .get::<newengine_gameplay_world_runtime::gameplay::PhysicsBodyDesc>(entity)
            .copied();
        let anchor_component = world.get::<newengine_gameplay_world_runtime::gameplay::SceneEntityAnchor>(entity);
