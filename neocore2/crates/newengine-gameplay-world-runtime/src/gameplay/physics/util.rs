...
#[inline]
pub(super) fn arr_to_vec3(v: [f32; 3]) -> Vec3 {
    Vec3::new(v[0], v[1], v[2])
}

#[inline]
pub(super) fn quat_to_arr(q: Quat) -> [f32; 4] {
    [q.x, q.y, q.z, q.w]
}

#[inline]
pub(super) fn arr_to_quat(q: [f32; 4]) -> Quat {
    Quat::from_xyzw(q[0], q[1], q[2], q[3]).normalize_or_identity()
}
