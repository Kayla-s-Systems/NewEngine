...
use newengine_materials::{
    ...
    MaterialLoadResponse, MaterialParamValue, MaterialTextureBindings, MaterialTextureRefInfo,
    MaterialTextureRefRequest, MaterialValidationRequest, MaterialValidationResult,
    MaterialsManifest, RenderMaterialPacket, ResolvedMaterialGraph, ShadingModel,
};
...
use newengine_materials::{
    method as material_method, ENGINE_ASSETS_MATERIALS_SERVICE_ID, MATERIALS_BACKEND_CAPABILITY_ID,
    MATERIALS_SERVICE_ID, MATERIALS_SERVICE_METHODS,
};
...
fn material_response_from_authored(
    source: &str,
    selector: &str,
