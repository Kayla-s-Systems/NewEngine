...
impl RenderFrameOrchestrator {
    ...
    pub(in super::super) fn should_publish_render_task_pass_event(frame_index: u64) -> bool {
        ...
        match policy.render_job_event_mode {
            newengine_runtime_policy::RenderJobEventMode::Off => false,
            newengine_runtime_policy::RenderJobEventMode::Full => true,
            newengine_runtime_policy::RenderJobEventMode::Sampled => {
                frame_index <= 3
