...
use newengine_engine_runtime::gameplay::{
    ...
    active_equipped_weapon_sight, consume_equipped_ammo, drain_weapon_reload_animation_markers,
    emit_animation_pulse, emit_gameplay_event, equipped_reserve_ammo,
    persist_equipped_weapon_state, resolve_weapon_impact, sync_equipped_weapon_runtime,
