...
pub(in crate::startup_window::egui_presenter) fn section_card(
    ui: &mut egui::Ui,
    title: &str,
    subtitle: &str,
    add_contents: impl FnOnce(&mut egui::Ui),
...
pub(in crate::startup_window::egui_presenter) fn warning_banner(ui: &mut egui::Ui, text: &str) {
...
pub(in crate::startup_window::egui_presenter) fn summary_metric(
    ui: &mut egui::Ui,
    label: &str,
    value: &str,
) {
