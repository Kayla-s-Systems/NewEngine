...
pub(super) fn spawn_skydome(
    ...
    let Some(primitive_id) = ensure_skydome_primitive(prims, &spec.mesh) else {
        ...
        tick_authored_sky_cycle(world, 0.0);
        return;
    };
    ...
    newengine_ulog_api::ulog::info!(
        "fps-authored skydome: follow_camera={} radius={:.1} mesh='{}' clouds='{}' profile='{}' celestial_visuals='procedural_in_sky_shader'",
        spec.follow_camera,
        spec.radius,
        spec.mesh,
