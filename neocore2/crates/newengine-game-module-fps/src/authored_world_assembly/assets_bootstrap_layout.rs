...
pub(super) struct AuthoredFpsSceneEntityLayout {
...
pub(super) fn spawn_authored_scene_entity_layout(
    world: &mut newengine_ecs::World,
    root: EntityId,
) -> AuthoredFpsSceneEntityLayout {
    let layout = AuthoredFpsSceneEntityLayout {
    ...
    newengine_ulog_api::ulog::info!(
        "fps-authored scene layout: all authored scene elements are ordinary ECS entities environment={:?} terrain={:?} foliage={:?} definitions={:?} actors={:?} cameras={:?} policy='no special scene side-channel elements'",
        layout.environment,
        layout.terrain,
        layout.foliage,
        layout.definitions,
...
pub(super) fn spawn_authored_terrain_reference(
    ...
    newengine_ulog_api::ulog::info!(
        "fps-authored terrain: procedural terrain disabled; authored world reference entity={:?} base_height={} policy='no default terrain mesh, no default terrain collider'",
        entity,
        spec.base_height
    );
    entity
