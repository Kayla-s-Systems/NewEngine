...
pub(super) fn spawn_game_ready_audio_emitters(
    world: &mut newengine_ecs::World,
    parent: EntityId,
    emitters: &[GameReadyAudioEmitterSpec],
) {
    for spec in emitters {
        ...
        newengine_ulog_api::ulog::info!(
            "game-ready audio emitter: entity={:?} id='{}' cue='{}' position={:?} spatial={} gain={:.3} autoplay={} occlusion={} source='YMAP profile.audio.emitters'",
            entity,
            spec.id,
            spec.emitter.cue,
            spec.position,
