use super::super::*;
pub(super) use newengine_authored_world_runtime::AuthoredMapCellDomain as AuthoredCellDomain;
...
use crate::content::{AuthoredMapStreamingSpec, AuthoredWorldPlacementSpec};
...
/// GameReady owns only ECS/material admission state. Residency planning, prediction,
...
fn replan_residency(
    ...
    state: &mut GameReadyAuthoredMapStreamingState,
    focus: newengine_authored_world_runtime::AuthoredMapStreamingFocus,
) {
