...
pub(crate) use animation::{
    player_left_hand_weapon_frame, player_resolved_weapon_ready_root,
    player_rifle_ready_body_frames, player_rifle_view_forward_model,
    player_rifle_view_rotation_world, player_right_hand_prop_frame,
