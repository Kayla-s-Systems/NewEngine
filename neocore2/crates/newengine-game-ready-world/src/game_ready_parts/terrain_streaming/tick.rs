...
fn responsive_stream_commit_budget(
    ...
    let interval_ms =
        crate::env_config::var_u64("NEWENGINE_SCENE_TERRAIN_STREAM_INTERVAL_MS", 16, 16, 2_000);
...
fn predictive_streaming_center(
    ...
    let read_ahead_sec =
        crate::env_config::var_f32("NEWENGINE_SCENE_TERRAIN_READ_AHEAD_SEC", 0.75, 0.0, 3.0);
...
fn terrain_commit_budget_ms() -> f32 {
    crate::env_config::var_f32("NEWENGINE_SCENE_TERRAIN_COMMIT_BUDGET_MS", 2.0, 0.25, 16.0)
}
