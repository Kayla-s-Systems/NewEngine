...
| `gui.editor.open.texture_dictionary` | `tools run northstar.gui_editor -- open --root $repo_root/EngineRepo/NewEngine --asset assets/ui/icons/builtin_icons.ytd` | yes | normal | — |
